...
2. Starts Weaver for OTLP ingestion and validation
...
The details page (`details.html`) is only generated if you have run tests locally,
since it requires the Weaver results which are not checked in.
