...
public class AwsBedrockReferenceTest {

    private static final Tracer tracer = GlobalOpenTelemetry.getTracer("gen_ai.reference");
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=== Reference: AWS Bedrock Java Conformance Test ===");
