"""Conformance test: Mem0 manual memory instrumentation.

Exercises: add memory, search memory, delete memory
against a mock Mem0 server, with manual span instrumentation.
"""
...
def _set_common_attrs(span, operation_name):
    ...
    span.set_attribute("gen_ai.system", "mem0")
...
def main():
    print("=== Manual: Mem0 Memory Conformance Test ===")
