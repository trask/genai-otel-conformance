"""Conformance test: reference instrumentation for Google ADK."""
...
_reference_tracer = _trace.get_tracer("gen_ai.reference")
...
def run_agent_reference():
    """Scenario: basic agent execution via Google ADK with reference instrumentation."""
    ...
    print("  [agent_run] basic ADK agent execution (reference)")
...
def main():
    print("=== Reference: Google ADK Conformance Test ===")
