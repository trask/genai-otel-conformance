"""Conformance test: reference instrumentation for AWS Bedrock."""
...
def run_converse_reference(client):
    """Scenario: Bedrock Converse API with reference instrumentation."""
    print("  [converse] Bedrock Converse API (reference)")
...
def run_embeddings_reference(client):
    """Scenario: Bedrock Titan Embeddings with reference instrumentation."""
    import json as _json

    print("  [embeddings] Bedrock Titan Embeddings (reference)")
...
def main():
    print("=== Reference: AWS Bedrock Conformance Test ===")
