"""Conformance test: OpenLLMetry (Traceloop) Vertex AI instrumentation.

Uses opentelemetry-instrumentation-vertexai to instrument the
...
def main():
    print("=== OpenLLMetry: Vertex AI Conformance Test ===")
