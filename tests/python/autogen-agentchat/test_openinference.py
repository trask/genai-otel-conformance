"""Conformance test: OpenInference (Arize) AutoGen AgentChat instrumentation.
...
def run_agent():
    ...
    print("  [agent_run] basic AutoGen AgentChat agent execution")
...
def main():
    print("=== OpenInference: AutoGen AgentChat Conformance Test ===")
