"""Conformance test: reference instrumentation for Haystack.
...
def run_chat():
    """Scenario: basic chat via Haystack pipeline with reference instrumentation."""
    print("  [chat] basic chat via Haystack pipeline (reference)")
...
def main():
    print("=== Reference: Haystack Conformance Test ===")
