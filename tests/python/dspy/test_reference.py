"""Conformance test: reference instrumentation for DSPy.
...
def run_chat():
    """Scenario: basic chat via DSPy LM with reference instrumentation."""
    print("  [chat] basic chat via DSPy LM (reference)")
    import dspy
...
def main():
    print("=== Reference: DSPy Conformance Test ===")
