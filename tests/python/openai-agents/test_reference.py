"""Conformance test: reference instrumentation for OpenAI Agents.
...
async def run_agent():
    ...
    print("  [agent_run] agent with tool calling (reference)")
...
def main():
    print("=== Reference: OpenAI Agents Conformance Test ===")
