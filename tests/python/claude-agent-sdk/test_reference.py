"""Conformance test: reference instrumentation for Claude Agent SDK."""
...
async def run_agent_query_reference():
    """Scenario: basic agent query via mock CLI with reference instrumentation."""
    ...
    print("  [agent_query] basic query via mock CLI (reference)")
...
def main():
    ...
    print("=== Reference: Claude Agent SDK Conformance Test ===")
