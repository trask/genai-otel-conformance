---
description: "Use when implementing or updating prototype instrumentation, manual spans, prototype tag/attribute emission, or data-prototype coverage in conformance tests. Keeps prototype instrumentation easy to scan and avoids helpers that hide emitted attributes."
applyTo: "tests/python/**/test_prototype.py, tests/js/**/test_prototype.ts, tests/java/**/src/main/java/**/*PrototypeTest.java, tests/dotnet/**/Program.cs"
---
...
- Keep prototype instrumentation easy to scan: the base attributes, derived attributes, and result attributes should appear together.
