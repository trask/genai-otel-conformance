---
description: "Use when implementing or updating reference instrumentation, manual spans, reference tag/attribute emission, or data-reference coverage in conformance tests. Keeps reference instrumentation easy to scan and avoids helpers that hide emitted attributes."
applyTo: "tests/python/**/test_reference.py, tests/js/**/test_reference.ts, tests/java/**/src/main/java/**/*ReferenceTest.java, tests/dotnet/**/Program.cs"
---
